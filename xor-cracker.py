...
if __name__ == '__main__':
    ...
    parser.add_argument('--min', action='store', dest='min_length', help='Minimum length of key.', type=int)
    parser.add_argument('--max', action='store', dest='max_length', help='Maximum length of key.', type=int)
    ...
    try:
        with open(args.file_in,'rb') as f:
            cipher=f.read()
            key_len = guest_key_length(args.min_length, args.max_length, cipher)
